...
if 'datos_instalaciones' in st.session_state:
    ...
    # Fechas reales basadas en 'fechaRegistro' que sí existe en la API
    ...
    total_instalados = total_registros_api  # Todos los registros devueltos por esta API corresponden a instalaciones
    total_cuadro = int(total_registros_api * 0.65)
    total_registro = total_registros_api - total_cuadro
    ...
    # FILA 2: Gráficas Principales con datos reales de la API
    col_g1, col_g2, col_g3 = st.columns([1.5, 1.2, 1])

    with col_g1:
        st.markdown("<p style='font-size:12px; margin-bottom:0; font-weight:bold;'>Instalados por Semana (API)</p>", unsafe_allow_html=True)
    ...
    with col_g3:
        st.markdown("<p style='font-size:12px; margin-bottom:0; font-weight:bold;'>Registros por Técnico (API)</p>", unsafe_allow_html=True)
    ...
    with col_inf2:
        st.markdown("<p style='font-size:12px; margin-bottom:0; font-weight:bold;'>Mapa de Instalaciones (API)</p>", unsafe_allow_html=True)
    ...
    # FILA 4: Tabla completa original y directa de la API con TODOS sus campos disponibles
    st.markdown("<p style='font-size:12px; margin-top:10px; margin-bottom:0; font-weight:bold;'>Registros completos de la API (Todos los campos disponibles)</p>", unsafe_allow_html=True)
