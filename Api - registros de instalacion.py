    ...
    with tab_principal:
        ...
        with col_inf2:
            ...
            with col_map_h:
                ...
                # Altura aumentada del mapa de 190 a 280 píxeles
                st_folium(mapa_miaa, width=None, height=280, use_container_width=True, key="mapa_estatico_instalaciones", returned_objects=[])
